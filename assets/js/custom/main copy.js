...
//  FINAL DECISION
templatePath = aiPath || originalPath;
...
function restoreMiddleSectionsForCurrentPage() {
    ...
    $(".component").each(function () {
        $(this).attr("data-ai-selected", "false");
        $(this).find(".ai-generated-section").hide();
        $(this).find(".original-section").show();
    });
    ...
    saved[selectedPage].forEach(section => {
        ...
        const isAI =
            templatePath &&
            (templatePath.includes("generated_sections") ||
             templatePath.includes("ai_generated"));
