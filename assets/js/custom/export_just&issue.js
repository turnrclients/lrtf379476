...
if (availableMiddleSectionsForPage.length > 0) {
    ...
    allSectionsOfPage.push({
        ...
        template: "/assets/middle_sections/default-middle_section.html" // IMPORTANT
    });
}
...
success: function (html) {
    ...
    const defaultTemplate = "/assets/middle_sections/default-middle_section.html"; // <-- set correct path
