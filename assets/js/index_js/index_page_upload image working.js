...
<div class="ai-modal-content">
    ...
    <div class="ai-actions">
        ...
        <button id="ai-apply" class="ai-btn">Apply</button>
...
document.getElementById("ai-apply").onclick = async function(){
    ...
    const generatedContainer = $("#ai-generated");

    generatedContainer.find("img").each(function(){
        $(this).css({
            outline: "",
            border: "",
            cursor: ""
    ...
    const generatedHTML = generatedContainer.html();
...
console.log("Images Data:", imagesData);
    ...
    const res = await fetch("/ai/save_section/", {
        ...
        body: JSON.stringify({
            ...
            sectionType: getSectionType(currentSection),
            images: imagesData
        })
    });
...
// alert("selectedImageSrc----" +selectedImageSrc);
    ...
    let generatedHTML = $("#ai-generated").html();
